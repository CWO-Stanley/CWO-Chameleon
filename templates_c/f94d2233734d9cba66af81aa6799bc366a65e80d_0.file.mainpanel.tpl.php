...
/app-assets/images/portrait/small/avatar-s-11.png" alt="avatar"><?php }?><i></i></span></a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><?php if ((isset($_smarty_tpl->tpl_vars['god']->value))) {?><img src="<?php echo $_smarty_tpl->tpl_vars['logo']->value;?>
" alt="avatar"><?php } else { ?><img src="<?php echo $_smarty_tpl->tpl_vars['fullurl']->value;?>
