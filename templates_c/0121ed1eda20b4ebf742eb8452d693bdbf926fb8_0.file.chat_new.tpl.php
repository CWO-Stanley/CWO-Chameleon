...
function content_5f7ce495abfd32_96602501 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- New Style -->
...
echo $_smarty_tpl->tpl_vars['playerkleur']->value;
					...
					<div class="row">
                        ...
                        <div class="form-group color-picker">
						<div class="position-relative has-icon-left">
                                            <input type="text" id="simple-color-picker" style="background-color: <?php if ((isset($_smarty_tpl->tpl_vars['tekstkleur']->value))) {
