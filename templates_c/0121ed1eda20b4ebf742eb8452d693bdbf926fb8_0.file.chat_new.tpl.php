<?php
/* Smarty version 3.1.34-dev-7, created on 2020-10-16 20:03:18
  from '/home/chatters/domains/chattersworld.nl/public_html/chameleon/templates/chat_new.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f89e066c1aae7_22606412',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0121ed1eda20b4ebf742eb8452d693bdbf926fb8' => 
    array (
      0 => '/home/chatters/domains/chattersworld.nl/public_html/chameleon/templates/chat_new.tpl',
      1 => 1602871382,
      2 => 'file',
    ),
  ),
...
function content_5f89e066c1aae7_22606412 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- New Style -->
...
<!-- end new -->
        ...
        <!-- Form wizard with step validation section start -->
                                <form id="form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['fullurl']->value;
if ((isset($_smarty_tpl->tpl_vars['chat_id']->value))) {?>/edit<?php } else { ?>/new<?php }?>" class="steps-validation">
...
>
                      ...
                      <label class="col-sm-2 col-form-label white" for="firstname">Kanaalnaam:</label>
						<div class="col-sm-4">
							<div class="form-group">
                            <input type="text" class="form-control required" name="chat_name" title="Dit is de naam die je chatbox zal krijgen." pattern="^[a-zA-Z0-9][a-zA-Z0-9-_\.]{1,}$" placeholder="Naam Chatbox" value="<?php if ((isset($_smarty_tpl->tpl_vars['chat_name']->value))) {
echo $_smarty_tpl->tpl_vars['chat_name']->value;
...
echo $_smarty_tpl->tpl_vars['chat_bgurl']->value;
					        ...
					        <label for="icon_prefix" title="Gebruikersicoontjes tonen voor chatters hun naam in het chatvenster (in plaats van enkel rechts in de lijst)." class="control-label col-sm-2 white">Icoontjes in de chat tonen</label>
								...
								<div class="c-inputs-stacked">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="icon_prefix" class="custom-control-input" id="item41" value="true" <?php if ($_smarty_tpl->tpl_vars['icon_prefix']->value == "true") {?>checked="checked"<?php }?>>
                    ...
                    <!-- Timestamp -->
					    ...
					    <div class="row">
					        <label for="timestamp" title="Deze instelling laat de tijd voor elk bericht zien." class="control-label col-sm-2 white">Tijd</label>
								...
								<div class="c-inputs-stacked">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="timestamp" class="custom-control-input" id="item42" value="true" <?php if ($_smarty_tpl->tpl_vars['timestamp']->value == "true") {?>checked="checked"<?php }?>>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="webcam_video" class="custom-control-input" id="item44" value="true" <?php if ($_smarty_tpl->tpl_vars['webcam_video']->value == "true") {?>checked="checked"<?php }?>>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="webcam_audio" class="custom-control-input" id="item45" value="true" <?php if ($_smarty_tpl->tpl_vars['webcam_audio']->value == "true") {?>checked="checked"<?php }?>>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" name="webcam_prive" class="custom-control-input" id="item46" value="true" <?php if ($_smarty_tpl->tpl_vars['webcam_prive']->value == "true") {?>checked="checked"<?php }?>>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="chat_prive" class="custom-control-input" id="item47" value="true" <?php if ($_smarty_tpl->tpl_vars['chat_prive']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item47"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="serverwindow" class="custom-control-input" id="item48" value="true" <?php if ($_smarty_tpl->tpl_vars['serverwindow']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item48"></label>
					...
					<div class="row">
                        <label for="chanellist" title="Met deze instelling wordt de knop om de kanaallijst (lijst van alle chatrooms op de server) te laten zien getoond." class="control-label col-sm-2 white">Laat knop kanaallijst zien</label>
                         <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="channellist" class="custom-control-input" id="item49" value="true" <?php if ($_smarty_tpl->tpl_vars['channellist']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item49"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="textstyling" class="custom-control-input" id="item50" value="true" <?php if ($_smarty_tpl->tpl_vars['textstyling']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item50"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="verboseinformation" class="custom-control-input" id="item51" value="true" <?php if ($_smarty_tpl->tpl_vars['verboseinformation']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item51"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="kiwi_avatar" class="custom-control-input" id="item52" value="true" <?php if ($_smarty_tpl->tpl_vars['kiwi_avatar']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item52"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="kiwi_upload" class="custom-control-input" id="item53" value="true" <?php if ($_smarty_tpl->tpl_vars['kiwi_upload']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item53"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="kiwi_giphy" class="custom-control-input" id="item54" value="true" <?php if ($_smarty_tpl->tpl_vars['kiwi_giphy']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item54"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="kiwi_imgur" class="custom-control-input" id="item55" value="true" <?php if ($_smarty_tpl->tpl_vars['kiwi_imgur']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item55"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="kiwi_asl" class="custom-control-input" id="item56" value="true" <?php if ($_smarty_tpl->tpl_vars['kiwi_asl']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item56"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="html_redirect" class="custom-control-input" id="item57" value="true" <?php if ($_smarty_tpl->tpl_vars['html_redirect']->value == "true") {?>checked="checked"<?php }?>>
                <label class="custom-control-label" for="item57"></label>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="radio_enabled" class="custom-control-input" id="item58" value="true" <?php if ($_smarty_tpl->tpl_vars['radio_enabled']->value == "true") {?>checked="checked"<?php }?>>
...
}?>;" name="playerkleur" class="form-control color-picker__value" placeholder="playerkleur" value="<?php if ((isset($_smarty_tpl->tpl_vars['playerkleur']->value))) {
echo $_smarty_tpl->tpl_vars['playerkleur']->value;
}?>" title="Deze kleur zal de achtergrond zijn van de radioplayer" data-toggle="tooltip" data-placement="top">
                                            <div class="form-control-position">
                                                <i class="la la-adjust black" style="background-color: <?php if ((isset($_smarty_tpl->tpl_vars['playerkleur']->value))) {
echo $_smarty_tpl->tpl_vars['playerkleur']->value;
}?>;"></i>
                                            </div>
                                        </div>
...
}?>;" name="tekstkleur" class="form-control color-picker__value" placeholder="tekstkleur" value="<?php if ((isset($_smarty_tpl->tpl_vars['tekstkleur']->value))) {
echo $_smarty_tpl->tpl_vars['tekstkleur']->value;
}?>" title="Deze kleur zal de text zijn van de radioplayer" data-toggle="tooltip" data-placement="top">
                                            <div class="form-control-position">
                                                <i class="la la-adjust black" style="background-color: <?php if ((isset($_smarty_tpl->tpl_vars['tekstkleur']->value))) {
echo $_smarty_tpl->tpl_vars['tekstkleur']->value;
}?>;"></i>
                                            </div>
                                        </div>
					...
					<div class="row">
                        ...
                        <div class="c-inputs-stacked">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" name="ads_enabled" class="custom-control-input" id="item59" value="true" <?php if ($_smarty_tpl->tpl_vars['ads_enabled']->value == "true") {?>checked="checked"<?php }?>>
