...
function content_5f7ce693ef48e5_16527765 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['metadata']->value['bgcolor'] == '#000000') {?>
	...
	<?php } else { ?>
		<?php if ($_smarty_tpl->tpl_vars['metadata']->value['bgurl'] == '') {?>
    background-image: linear-gradient(rgba(255,255,255, .50), rgba(255,255,255, .50)), url(cwobg.jpg);background-size: 100% 100%;<?php } else { ?>
