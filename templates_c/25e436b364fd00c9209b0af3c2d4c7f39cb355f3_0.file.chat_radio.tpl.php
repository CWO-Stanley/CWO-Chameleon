...
function content_5f7ce47d63a2e6_07487726 (Smarty_Internal_Template $_smarty_tpl) {
...
>
		<?php echo '<script'; ?>
 src="radiolibs/sticky/js/audio8_html5.js?v=2.0" type="text/javascript"><?php echo '</script'; ?>
>
...
>
		<?php echo '<script'; ?>
 type="text/javascript" src="radiolibs/luna/lunaradio.min.js?v=5.20.08.31"><?php echo '</script'; ?>
>
...
>
<?php echo '<script'; ?>
 src="radiolibs/hero/js/audio6_html5.js?v=2.0" type="text/javascript"><?php echo '</script'; ?>
>
		<?php echo '<script'; ?>
>
			jQuery(function() {
...
>
		<?php echo '<script'; ?>
 src="radiolibs/clever/js/audio11_html5.js" type="text/javascript"><?php echo '</script'; ?>
>
		<!-- must have -->
		<?php echo '<script'; ?>
>
