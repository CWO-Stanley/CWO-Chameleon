...
#clock {
  ...
  <body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-blue" data-col="2-columns">
	...
	<footer class="footer footer-static footer-dark navbar-border navbar-shadow">
        <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">© {$sitename} All rights reserved. v11.0 {if isset($god)}Geregistreerd aan: {$registeredname}, Verval datum: {$nextduedate}, Product: {$productname}{/if}</span>
...
$(function() {
  $("#graph_select").change(function() {
	...
	else if ($("#coffee").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	else if ($("#dark").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	...
	else if ($("#elite").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	else if ($("#grayfox").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	else if ($("#osprey").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	else if ($("#radioactive").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
	else if ($("#sky").is(":selected")) {
      // $("#pilot_graph_form").show();
      $("#html5color").fadeOut(1000);
	  $("#omswitch").fadeOut(1000);
    }
