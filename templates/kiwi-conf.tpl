		...
		"plugin-conference":{ 
				...
				"configOverwrite": {
					...
					"notifications": [
							...
							{/literal}{if $metadata['mic'] == "true"}{else}"dialog.micNotSendingData", {/if}{literal}// shown when user's mic is not sending any audio
							...
							{/literal}{if $metadata['mic'] == "true"}{else}"notify.newDeviceAudioTitle", {/if}{literal}// prompts the user to use a newly detected audio device
							...
							{/literal}{if $metadata['mic'] == "true"}{else}"notify.startSilentTitle", {/if}{literal}// shown when user joined with no audio
							...
							{/literal}{if $metadata['mic'] == "true"}{else}"toolbar.noAudioSignalTitle", {/if}{literal}// shown when a broken mic is detected
