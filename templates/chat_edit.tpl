					...
					<div class="row">
                        ...
                        <div class="col-sm-4"><div class="form-group">
                            <select id="videoheight" class="select2 form-control" id="default-select2" name="videoheight">
                                <option value="180" {if $videoheight1=="180"}selected="selected"{/if}>360 (Laag)</option>
								<option value="360" {if $videoheight1=="360"}selected="selected"{/if}>480 (Middel)</option>
                                <option value="405" {if $videoheight1=="405"}selected="selected"{/if}>720 (Hoog)</option>
                            </select>
                        </div>
                    </div>
					</div>
